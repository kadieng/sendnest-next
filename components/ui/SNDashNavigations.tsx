    ...
    return (
        <>
                                                    ...
                                                    {navigation.map((item) => (
                                                        <li key={item.name}>
                                                            ...
                                                            >
                                                                <item.icon
                                                                    className={classNames(
                                                                        currentRoute === item.href ? "text-white" : "text-primary" +
                        ...
                        <ul role="list" className="flex flex-1 flex-col gap-y-7">
                            ...
                            <li
                                ...
                                >
                                    <Cog6ToothIcon
                                        className={classNames(
                                            currentRoute.includes("/dashboard/settings") ? "text-white" : "text-primary" +
                                                " group-hover:text-white",
                                            "h-6 w-6 shrink-0"
                                        )}
                                        aria-hidden="true"
            ...
            <div className="lg:pl-72">
                <div
                    className="sticky top-0 z-40 flex h-16 shrink-0 items-center gap-x-4 bg-white px-4 sm:gap-x-6 sm:px-6 lg:px-8">
