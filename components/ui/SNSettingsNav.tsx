...
export default function SNSettingsNav() {
  ...
  return (
    <div className="w-5/6 md:w-[35%] lg:w-[35%] xl:w-[25%] 2xl:w-1/5">
      ...
      >
        <div className="flex h-6 w-6 items-center justify-center rounded-full bg-[#ECECED] active">
          <Image src={currentRoute === '/dashboard/settings' ? inactiveImg : activeImg} width="15" height="15" alt="" />
        </div>
      ...
      >
        <div className="flex h-6 w-6 items-center justify-center rounded-full bg-[#ECECED]">
          <Image
            src={currentRoute === '/dashboard/settings/security' ? inactiveImg : activeImg}
            width="15"
            height="15"
            alt=""
          />
