...
export default function SNTestimonials() {
    return (
        ...
        <div className="clients-bg relative h-[1000px] md:h-[700px]">
            <h1
                className="font-radio-canada pt-16 text-center text-4xl font-semibold text-[#424242] md:text-5xl"
            >
                What our Clients are sayings
            </h1>
            <div className="relative flex justify-center">
                <div
                    className="relative mt-48 h-[180px] w-[300px] md:mt-32 md:h-[240px] md:w-[500px] lg:h-[270px]"
                >
                    <div
                        className="font-inter relative z-20 h-full w-full rounded-[10px] bg-[#372666] pl-5 pr-8 pt-4 text-xs text-white md:pt-10 md:text-base"
                    >
                        I've been using SendNest to send money to my family in Nigeria for
                        over a year now, and I couldn't be happier with the service. The
                        website is user-friendly, and the fees and exchange rates are always
                        transparent. I appreciate that I can track the status of my transfer
                        and receive updates throughout the process.
                    </div>

                    <div
                        className="absolute -bottom-[11px] z-10 h-20 w-full rounded-[10px] bg-[#D5AF34]"
                    ></div>
                    ...
                    <div className="relative bottom-[40px] left-28 md:left-32">
                        ...
                        <svg
                            width="120"
                            height="130"
                            className="absolute left-[18px] z-10 rotate-90"
                        >
