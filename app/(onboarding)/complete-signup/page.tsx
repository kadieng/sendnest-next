...
export default function CompleteSignup() {
    ...
    return (
        <div className="isolate flex justify-center bg-white px-6 py-12 sm:py-16 lg:px-8">
            ...
            <Card
                isBlurred
                className="border-none bg-background/40 dark:bg-default-100/50 max-w-[610px]"
                shadow="sm"
            >
                <CardBody className="p-12">
                    <div className="mx-auto w-full max-w-2xl text-center">
                        <h2 className="text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">Complete Signup
                            Process</h2>
                        <p className="mt-2 text-lg leading-8 text-gray-600">
                            Fill in the code sent to your email after submitting your form
                        </p>
                    </div>
                    <form action="#" method="POST" className="mx-auto w-full mt-10 max-w-lg">
