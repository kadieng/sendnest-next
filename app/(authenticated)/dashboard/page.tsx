        ...
        <>
            <div className="flex flex-col gap-14 px-3 md:flex-row md:px-7 lg:px-10">
                <div className="pt-11 lg:pt-0">
                    ...
                    <div
                        className="mt-5 flex h-28 w-full flex-col justify-between rounded-2xl p-5 shadow-md md:w-[280px]"
                    >
                    ...
                    <div
                        className="font-radio-canada mt-5 flex h-24 w-full flex-col justify-between rounded-lg border-2 border-[#A596CF] p-2 text-lg font-light text-[#A596CF] md:w-[280px]"
                    >
                        <div className="flex items-center justify-between">
                            <p>Exchange Rate</p>
                            <p>750 NGN</p>
                    ...
                    <div
                        className="font-radio-canada mt-5 flex w-full items-center justify-between font-light md:w-[280px]"
                    >
                    ...
                    <button
                        className="font-radio-canada mt-5 flex h-11 w-full items-center justify-center rounded-lg bg-primary font-semibold text-white md:w-[280px]"
                    >
                        Send Money
                    </button>
                </div>
